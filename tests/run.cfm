...
<cfparam name="url.debug" default="true">
<cfparam name="url.quiet" default="false">
<cfparam name="url.includeGW" default="false">
<cfparam name="url.gatewayFilter" default="virtualMerchant"><!--- virtualMerchant | authorizenet | pccharge ---><!--- specify a specific gateway folder name to only run a single gateway's tests --->
