...
<cfif structKeyExists(variables, "authresponse")>
	<cfdump var="#variables.authresponse.getMemento()#" label="authresponse"/>
<cfelse>
	<h2><em>variables.authresponse</em> is not defined</h2>
</cfif>
</cfif>
<cfoutput>
<form action="#URLSessionFormat(CGI.SCRIPT_NAME)#" method="post" name="mainform" id="mainform">
	...
	<ct:formedit title="Customer IP Address" name="IPAddress" required="false" value="#form.IPAddress#" size="57">
	<cfoutput>
	</fieldset>
