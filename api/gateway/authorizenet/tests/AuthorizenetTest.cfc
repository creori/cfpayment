<cfcomponent name="AuthorizenetTest" extends="mxunit.framework.TestCase" output="false" hint="Basically the Braintree tests, but a couple additions">
	...
	<cffunction name="setUp" returntype="void" access="public">	
		<cfscript>  
			...
			gw.MerchantAccount = "6ay34R37ftsRGF24"; // Insert your developer or production merchant account number here.
			gw.Username = "62weFnt8Squs"; // Insert your developer or production username here.
	...
	<cffunction name="testAuthorizeOnly" access="public" returntype="void" output="false">
		<cfset var money = variables.svc.createMoney(5132) /><!--- in cents, $50.00 --->
		<cfset var response = "" />
		<cfset var options = structNew() />
