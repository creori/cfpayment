<form action="https://demo.myvirtualmerchant.com/VirtualMerchantDemo/process.do" method="POST">
	<input type="hidden" name="ssl_merchant_id" value="001511">
	<input type="hidden" name="ssl_user_id" value="001511">
	<input type="hidden" name="ssl_pin" value="IW6YWR">
	...
	<input type="hidden" name="ssl_exp_date" value="1212">
